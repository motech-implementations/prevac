...
public class ValidationError {
    ...
    public static final String SITE_NAME_NULL = "siteName property can't be null";
    public static final String COMMUNITY_NULL = "community property can't be null";
    ...
    public static final String AGE_NULL = "age property can't be null";
    public static final String AGE_NEGATIVE = "age property can't be negative";
    public static final String GENDER_NULL = "gender property can't be null";
